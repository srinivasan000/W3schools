...
<!-- Mirrored from www.w3schools.com/jsref/tryit.asp?filename=tryjsref_week_stepdown2 by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Sep 2021 03:25:04 GMT -->
<head>
...
<p>Click the button to decrement the value of the week field by 1 week (each time you click).</p>

<p><strong>Note:</strong> This is the same as clicking the down arrow on the right side of the week field for the "week" section.</p>
