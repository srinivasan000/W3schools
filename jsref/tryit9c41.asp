...
<!-- Mirrored from www.w3schools.com/jsref/tryit.asp?filename=tryjsref_password_defaultvalue3 by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Sep 2021 03:24:51 GMT -->
<head>
...
<p>Change the value of the password field, and then click the button below.</p>

Password: <input type="password" id="myPsw" value="mypwd345">

<p>Note that the default value is not affected when you change the value of the password field.</p>
...
function myFunction() {
  ...
  if (defaultVal == currentVal) {
    ...
    + "<br>Change the value of the password field to see the difference!";
  } else {
