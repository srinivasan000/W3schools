...
<!-- Mirrored from www.w3schools.com/jsref/tryit.asp?filename=tryjsref_submit_formnovalidate by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Sep 2021 03:24:57 GMT -->
<head>
...
<p>Click the "Try it" button to find out if the form-data should be validated or not, when submitted.</p>
