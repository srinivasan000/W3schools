...
<!-- Mirrored from www.w3schools.com/jsref/tryit.asp?filename=tryjsref_video_startdate by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Sep 2021 03:25:33 GMT -->
<head>
...
<p>Click the button to get the current timeline offset of the video.</p>

<button onclick="myFunction()">Try it</button>

<p><strong>Note:</strong> The startDate property is not supported in any major browsers.
