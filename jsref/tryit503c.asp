...
<!-- Mirrored from www.w3schools.com/jsref/tryit.asp?filename=tryjsref_video_autoplay2 by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Sep 2021 03:25:30 GMT -->
<head>
...
<p>Click the buttons to create a VIDEO element, one with autoplay set to true, and one with autoplay set to false.</p>
