...
<!-- Mirrored from www.w3schools.com/jsref/tryit.asp?filename=tryjsref_meter_max2 by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Sep 2021 03:25:11 GMT -->
<head>
...
<p>Peter's score: <meter id="myMeter" min="0" low="40" high="75" max="100" value="65"></meter></p>

<p>Click the button to change the value of the max attribute of the gauge above.</p>

<button onclick="myFunction()">Try it</button>

<p><b>Note:</b> The max property is not supported in Internet Explorer and Safari 5 (and earlier versions).</p>
