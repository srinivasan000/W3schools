...
<!-- Mirrored from www.w3schools.com/jsref/tryit.asp?filename=tryjsref_submit_formaction2 by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Sep 2021 03:24:57 GMT -->
<head>
...
<p>This example contains a form with a submit button that submits the form to "/action_page.php":</p>
...
<p>Click the "Try it" button to change the value of the formaction attribute of the submit button above.</p>
...
<script>
function myFunction() {
  document.getElementById("mySubmit").formAction = "../action_page2.html";
