...
<!-- Mirrored from www.w3schools.com/jsref/tryit.asp?filename=tryjsref_submit_formaction by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Sep 2021 03:24:57 GMT -->
<head>
...
<p>Click the "Try it" button to display the value of the formaction attribute of the submit button above.</p>

<p>Notice that the formaction attribute overrides the HTML form's action attribute (action_page.php).</p>
