...
<!-- Mirrored from www.w3schools.com/jsref/tryit.asp?filename=tryjsref_search_name2 by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Sep 2021 03:24:56 GMT -->
<head>
...
<p>Click the buttons to display and/or change the value of the name attribute of the search field.</p>
...
function display() {
  ...
  alert("The name of the search field is: " + x);
}
