...
<!-- Mirrored from www.w3schools.com/jsref/tryit.asp?filename=tryjsref_table_createtfoot by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Sep 2021 03:25:25 GMT -->
<head>
...
<p>Click the button to create a tfoot element for the table.</p>
...
<p><b>Note:</b> The tfoot element must have one or more tr elements inside of it. Therefore, we use the insertRow() and insertCell() methods to create and insert tr and td elements to the newly created tfoot element.</p>
