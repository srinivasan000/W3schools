...
<!-- Mirrored from www.w3schools.com/jsref/tryit.asp?filename=tryjsref_select_autofocus by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Sep 2021 03:25:22 GMT -->
<head>
...
<p>Click the button to find out if the drop-down list automatically gets focus when the page loads.</p>
