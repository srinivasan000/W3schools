...
<!-- Mirrored from www.w3schools.com/jsref/tryit.asp?filename=tryjsref_video_error by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Sep 2021 03:25:31 GMT -->
<head>
...
<video id="myVideo" width="320" height="240" controls>
  <source src="mov_broken-3.html" type="video/mp4">
  <source src="mov_broken.html" type="video/ogg">
  Your browser does not support the video tag.
</video>

<p>Click the button to get the error state of the video.</p>

<button onclick="myFunction()">Try it</button>

<p><strong>Note:</strong> The error property is only supported in Internet Explorer 9 and higher versions.</p>
...
<!-- Mirrored from www.w3schools.com/jsref/tryit.asp?filename=tryjsref_video_error by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Sep 2021 03:25:32 GMT -->
</html>
</textarea>
