...
<!-- Mirrored from www.w3schools.com/jsref/tryit.asp?filename=tryjsref_number_autofocus by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Sep 2021 03:24:49 GMT -->
<head>
...
<input type="number" id="myNumber" autofocus>

<p>Click the button to find out if the number field automatically gets focus when the page loads.</p>
