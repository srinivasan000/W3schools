...
<!-- Mirrored from www.w3schools.com/jsref/tryit.asp?filename=tryjsref_output_name2 by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Sep 2021 03:25:15 GMT -->
<head>
...
<p>Click the button to change the name of the output element.</p>
...
function myFunction() {
  ...
  document.getElementById("demo").innerHTML = "The name of the output element was changed from 'x' to 'newOutputName'.";
}
</script>
