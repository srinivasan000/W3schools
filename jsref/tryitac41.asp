...
<!-- Mirrored from www.w3schools.com/jsref/tryit.asp?filename=tryjsref_submit_formmethod by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Sep 2021 03:24:57 GMT -->
<head>
...
<p>Click the "Display formmethod" button to display the value of the formmethod attribute of the submit button above.</p>

<p>When submitting the form, notice that the button's formmethod overrides the form's method (get).</p>
