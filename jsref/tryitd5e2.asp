...
<!-- Mirrored from www.w3schools.com/jsref/tryit.asp?filename=tryjsref_textarea_name2 by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Sep 2021 03:25:29 GMT -->
<head>
...
<p>Click the buttons below to display and/or change the value of the name attribute of the text area.</p>
...
function display() {
  ...
  alert("The name of the text area is: " + x);
}
