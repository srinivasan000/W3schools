...
<!-- Mirrored from www.w3schools.com/jsref/tryit.asp?filename=tryjsref_radio_autofocus by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Sep 2021 03:24:52 GMT -->
<head>
...
<p>Click the "Try it" button to find out if the radio button automatically gets focus when the page loads.</p>
