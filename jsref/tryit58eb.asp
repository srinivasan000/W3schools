...
<!-- Mirrored from www.w3schools.com/jsref/tryit.asp?filename=tryjsref_number_required by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Sep 2021 03:24:50 GMT -->
<head>
...
<form action="https://www.w3schools.com/action_page.php">
  Number: <input type="number" id="myNumber" name="quantity" required>
  <input type="submit">
</form>

<p>Click the "Try it" button to find out if the number field must be filled out before submitting the form.</p>
