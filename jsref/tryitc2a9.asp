...
<!-- Mirrored from www.w3schools.com/jsref/tryit.asp?filename=tryjsref_month_stepup2 by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Sep 2021 03:24:48 GMT -->
<head>
...
<div class="w3-bar" style="overflow:auto">
  ...
  <button id="runbtn" class="w3-button w3-bar-item w3-hover-white w3-hover-text-green" onclick="submitTryit(1);ga('send', 'event', 'runCode', 'click');">Run &#10095;</button>
...
<p>Click the button to increment the value of the month field by 1 month (each time you click).</p>

<p><strong>Note:</strong> This is the same as clicking the up arrow on the right side of the date field for the "month" section.</p>

<button onclick="myFunction()">Try it</button>

<p><strong>Note:</strong> The stepUp() method is not supported by Firefox.</p>
...
<!-- Mirrored from www.w3schools.com/jsref/tryit.asp?filename=tryjsref_month_stepup2 by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Sep 2021 03:24:49 GMT -->
</html>
</textarea>
