...
<!-- Mirrored from www.w3schools.com/jsref/tryit.asp?filename=tryjsref_input_time_defaultvalue3 by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Sep 2021 03:25:00 GMT -->
<head>
...
<p>Change the time of the time field, and then click the button below.</p>

Time: <input type="time" id="myTime" value="16:32:55">

<p>Note that the default value is not affected when you change the value of the time field.</p>
