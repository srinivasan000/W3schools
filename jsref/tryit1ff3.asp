...
<!-- Mirrored from www.w3schools.com/jsref/tryit.asp?filename=tryjsref_map_name2 by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Sep 2021 03:25:10 GMT -->
<head>
...
<p>Click the button to change the name of the image-map.</p>
...
function myFunction() {
  ...
  document.getElementById("demo").innerHTML = "The value of the name attribute was changed from 'planetmap' to 'newMapName'.";
}
</script>
