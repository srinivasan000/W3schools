...
<!-- Mirrored from www.w3schools.com/jsref/tryit.asp?filename=tryjsref_url_autocomplete2 by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Sep 2021 03:25:01 GMT -->
<head>
...
<p>Click the "Try it" button to find out whether the URL field has autocomplete set to "on" or "off".</p>

<button onclick="myFunction()">Try it</button>

<p><b>Note:</b> If you are new to the autocomplete attribute, fill in a URL, starting with "http://", and submit the form, then reload the page, start to fill in the same values in the URL field again - the browser will suggest values based on the values that you entered before.</p>
