...
<!-- Mirrored from www.w3schools.com/jsref/tryit.asp?filename=tryjsref_input_time_stepup2 by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Sep 2021 03:25:01 GMT -->
<head>
...
<p>Click the button to increment the value of the time field by 1 minute (each time you click).</p>

<p><strong>Note:</strong> This is the same as clicking the up arrow on the right side of the time field for the "minute" section.</p>
