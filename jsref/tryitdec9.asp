...
<!-- Mirrored from www.w3schools.com/jsref/tryit.asp?filename=tryjsref_output_value2 by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Sep 2021 03:25:15 GMT -->
<head>
...
<p>Click the button to display the result of the calculation.</p>

<p><strong>Note:</strong> For this example to work, the result must be shown in the output element. The output element is not supported in Internet Explorer.</p>
