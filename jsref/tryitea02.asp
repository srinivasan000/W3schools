...
<!-- Mirrored from www.w3schools.com/jsref/tryit.asp?filename=tryjsref_radio_name2 by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Sep 2021 03:24:53 GMT -->
<head>
...
<p>Click the buttons below to display and/or change the value of the name attribute of the radio button.</p>
...
function display() {
  ...
  alert("The name of the radio button is: " + x);
}
