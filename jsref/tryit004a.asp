...
<!-- Mirrored from www.w3schools.com/jsref/tryit.asp?filename=tryjsref_li_value2 by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Sep 2021 03:25:05 GMT -->
<head>
...
<ol>
  <li id="myLi" value="100">Coffee</li>
  <li>Tea</li>
  <li>Milk</li>
  <li>Water</li>
  <li>Juice</li>
...
<p>Click the "Try it" button to display the value of the value attribute of the li element.</p>
