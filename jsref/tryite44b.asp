...
<!-- Mirrored from www.w3schools.com/jsref/tryit.asp?filename=tryjsref_input_time_autofocus by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Sep 2021 03:24:59 GMT -->
<head>
...
<p>Click the button to find out if the time field automatically gets focus when the page loads.</p>
